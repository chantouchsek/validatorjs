export default {
  ...
  email:
    ':attribute maydoniga haqiqiy elektron pochta manzili kiritilishi kerak.',
  def: ':attribute maydonida xatolar mavjud.',
  digits: ':attribute maydonning uzunligi :digits bo`lishi kerak',
  digits_between:
    ':attribute maydonining uzunligi :min dan :max belgilargacha bo`lishi kerak.',
  different:
    ':attribute va :different maydonlar qiymatlari farqli bo`lishi kerak.',
  ...
  min: {
    numeric:
      ':attribute maydonining qiymati :min dan katta yoki unga teng bo`lishi kerak.',
    string: ':attribute maydonidagi belgilar soni kamida :min bo`lishi kerak.',
  },
  max: {
    numeric:
      ':attribute maydonining qiymati :max dan kam yoki unga teng bo`lishi kerak.',
  ...
  present:
    ':attribute maydoni mavjud bo`lishi kerak (lekin bo`sh bo`lishi mumkin).',
  ...
  size: {
    numeric:
      ':attribute maydonining qiymati :size o`lchamiga teng bo`lishi kerak.',

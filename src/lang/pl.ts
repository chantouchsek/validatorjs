module.exports = {
  ...
  after_or_equal:
    'Data w polu :attribute musi być mniejsza lub równa :after_or_equal.',
  ...
  digits_between:
    'Pole :attribute musi zawierać się pomiędzy :min i :max cyfr.',
  ...
  required_unless:
    'Pole :attribute jest wymagane, jeśli pole :other nie jest równe :value.',
  required_with:
    'Pole :attribute jest wymagane, jeśli pole :other nie jest puste.',
  required_with_all:
    'Pole :attribute jest wymagane, jeśli pola :fields nie są puste.',
  required_without:
    'Pole :attribute jest wymagane, jeśli pole :field jest puste.',
  required_without_all:
    'Pole :attribute jest wymagane, jeśli pola :fields są puste.',
